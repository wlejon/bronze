...
TEST_CASE("a two-read loop becomes a fast copy, two guards and two trampolines") {
    ...
    CHECK(body(module) ==
          ...
          "    %3: f64 = const.f64 0\n"
          "    jump b7(%2, %3)\n"
          "  b1(%4: dynamic, %5: f64) [slow 0]:\n"
          "    %9: bool = cmp.lt %5, %1\n"
          "    br %9, b2, b6(%4, %5)\n"
          "  b2 [slow 0]:\n"
          "    %12: dynamic = prop.get %0, 10, 4\n"
          "    jump b3(%4, %5, %12)\n"
          "  b3(%31: dynamic, %32: f64, %33: dynamic) [slow 0]:\n"
          "    %13: dynamic = add %31, %33\n"
          "    %14: dynamic = prop.get %0, 11, 5\n"
          "    jump b4(%32, %13, %14)\n"
          "  b4(%34: f64, %35: dynamic, %36: dynamic) [slow 0]:\n"
          "    %15: dynamic = add %35, %36\n"
          "    jump b5(%15, %34)\n"
          "  b5(%10: dynamic, %11: f64) [slow 0]:\n"
          "    %16: f64 = const.f64 1\n"
          "    %17: f64 = add %11, %16\n"
          "    jump b1(%10, %17)\n"
          "  b6(%7: dynamic, %8: f64):\n"
          "    ret %7\n"
          "  b7(%18: f64, %19: f64) [fast 0]:\n"
          "    %20: bool = cmp.lt %19, %1\n"
          "    br %20, b8, b14\n"
          "  b8 [fast 0]:\n"
