...
// cycle by name because it has no temporal dead zone, and the analysis that
// separates this case from one whose cycle reads a `let` at evaluation time is
// a whole-graph reachability question over module-evaluation-time calls that is
// not built.
import { a } from './a.js';
