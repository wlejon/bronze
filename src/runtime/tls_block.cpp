...
extern "C" bronze_tls_block* bronze_tls_block_addr(void) {
    ...
    // never match a live epoch; the enable flags start at 1 and are lowered
    // per thread by Heap's constructor under their BRONZE_NO_* env vars.
    static thread_local bronze_tls_block block = {
        /*frame_top=*/nullptr,
