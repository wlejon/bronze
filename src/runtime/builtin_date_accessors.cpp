...
// call did not supply, which is exactly what the algorithms want. The
// `length` column is the clause's count of the same arguments — 4 for
// `setHours(hour [, min [, sec [, ms]]])` — which is the one a program reads.
const NativeMethod kAccessors[] = {
    {"getTime", dateGetTime, 0, 0},
    {"valueOf", dateValueOf, 0, 0},
    {"getTimezoneOffset", dateGetTimezoneOffset, 0, 0},

    {"getFullYear", dateGetField<dt::yearFromTime, true>, 0, 0},
    {"getMonth", dateGetField<dt::monthFromTime, true>, 0, 0},
    {"getDate", dateGetField<dt::dateFromTime, true>, 0, 0},
    {"getDay", dateGetField<dt::weekDay, true>, 0, 0},
    {"getHours", dateGetField<dt::hourFromTime, true>, 0, 0},
    {"getMinutes", dateGetField<dt::minFromTime, true>, 0, 0},
    {"getSeconds", dateGetField<dt::secFromTime, true>, 0, 0},
    {"getMilliseconds", dateGetField<dt::msFromTime, true>, 0, 0},

    {"getUTCFullYear", dateGetField<dt::yearFromTime, false>, 0, 0},
    {"getUTCMonth", dateGetField<dt::monthFromTime, false>, 0, 0},
    {"getUTCDate", dateGetField<dt::dateFromTime, false>, 0, 0},
    {"getUTCDay", dateGetField<dt::weekDay, false>, 0, 0},
    {"getUTCHours", dateGetField<dt::hourFromTime, false>, 0, 0},
    {"getUTCMinutes", dateGetField<dt::minFromTime, false>, 0, 0},
    {"getUTCSeconds", dateGetField<dt::secFromTime, false>, 0, 0},
    {"getUTCMilliseconds", dateGetField<dt::msFromTime, false>, 0, 0},

    {"setTime", dateSetTime, 0, 1},
    {"setHours", dateSetTimeFields<0, true>, 0, 4},
    {"setMinutes", dateSetTimeFields<1, true>, 0, 3},
    {"setSeconds", dateSetTimeFields<2, true>, 0, 2},
    {"setMilliseconds", dateSetTimeFields<3, true>, 0, 1},
    {"setUTCHours", dateSetTimeFields<0, false>, 0, 4},
    {"setUTCMinutes", dateSetTimeFields<1, false>, 0, 3},
    {"setUTCSeconds", dateSetTimeFields<2, false>, 0, 2},
    {"setUTCMilliseconds", dateSetTimeFields<3, false>, 0, 1},

    {"setFullYear", dateSetDateFields<0, true>, 0, 3},
    {"setMonth", dateSetDateFields<1, true>, 0, 2},
    {"setDate", dateSetDateFields<2, true>, 0, 1},
    {"setUTCFullYear", dateSetDateFields<0, false>, 0, 3},
    {"setUTCMonth", dateSetDateFields<1, false>, 0, 2},
    {"setUTCDate", dateSetDateFields<2, false>, 0, 1},
};
