...
// exceptions:
//
//   - a store through an unproven receiver to a field name matching NO declared pin.
//     Stores to known pinned slot names emit write barriers even through dynamic
//     or untyped receivers via `lookupField`.
