...
#define BRONZE_TLS_PROTO_EPOCH_OFF                 0
#define BRONZE_TLS_ALLOC_CURSOR_OFF                8
#define BRONZE_TLS_ALLOC_LIMIT_OFF                16
#define BRONZE_TLS_PLAIN_SHAPE_OFF                24
#define BRONZE_TLS_INLINE_CALL_ENABLED_OFF        32
#define BRONZE_TLS_ARRAY_METHOD_IC_ENABLED_OFF    40
#define BRONZE_TLS_INLINE_OVERFLOW_SET_ENABLED_OFF 48
#define BRONZE_TLS_INLINE_ACCESSOR_ENABLED_OFF    56
#define BRONZE_TLS_POLY_IC_ENABLED_OFF            64
#define BRONZE_TLS_NEGATIVE_IC_ENABLED_OFF        72
#define BRONZE_TLS_ELEM_IC_ENABLED_OFF            80
#define BRONZE_TLS_DIRECT_CALLOUT_ENABLED_OFF     88
#define BRONZE_TLS_ELEM_ABSENT_ENABLED_OFF        96
#define BRONZE_TLS_FN_SINGLETON_CACHE_ENABLED_OFF 104
#define BRONZE_TLS_ARRAY_METHOD_TBL_OFF          112
#define BRONZE_TLS_ITER_FAST_ENABLED_OFF         120
#define BRONZE_TLS_INLINE_ROOTS_ENABLED_OFF      128
#define BRONZE_TLS_STRICT_EQ_INLINE_ENABLED_OFF  136
#define BRONZE_TLS_ELEM_INLINE_ENABLED_OFF       144
#define BRONZE_TLS_ELEM_CACHE_TBL_OFF            152
#define BRONZE_TLS_METHOD_CALL_IC_ENABLED_OFF    160
#define BRONZE_TLS_ELEM_KEY_IC_ENABLED_OFF       168
#define BRONZE_TLS_UNDEF_REL_ENABLED_OFF         176
#define BRONZE_TLS_SORT_FAST_ENABLED_OFF         184
#define BRONZE_TLS_MAP_FAST_ENABLED_OFF          192
#define BRONZE_TLS_TA_SET_FAST_ENABLED_OFF       200
#define BRONZE_TLS_TRUTHY_INLINE_ENABLED_OFF     208
#define BRONZE_TLS_ELEM_SET_CACHE_TBL_OFF        216
#define BRONZE_TLS_STACK_LIMIT_OFF               224
#define BRONZE_TLS_MODULE_DELTAS_OFF             232
#define BRONZE_TLS_GC_CELL_HEADER_OFF            240
 ...
 * above through it — the inline caches, the allocation fast path, the
 * stack-limit check — instead of calling
