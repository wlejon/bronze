...
function(bronze_add_module name)
    ...
    if(MSVC)
        ...
        target_compile_options(bronze_${name} PRIVATE -Wall -Wextra -Werror -Wno-missing-field-initializers)
    ...
    if(ARG_TEST_SOURCES AND BRONZE_BUILD_TESTS)
        ...
        if(MSVC)
            ...
            target_compile_options(bronze_${name}_tests PRIVATE -Wall -Wextra -Werror -Wno-missing-field-initializers)
            if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
